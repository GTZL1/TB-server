...
class Routes(
  ...
  def documentation = List(
    ...
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """newAccount""", """controllers.HomeController.newAccount"""),
  ...
  // @LINE:11
  private[this] lazy val controllers_HomeController_rules5_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("rules")))
  )
  private[this] lazy val controllers_HomeController_rules5_invoker = createInvoker(
    HomeController_1.rules,
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.HomeController",
      "rules",
  ...
  // @LINE:12
  private[this] lazy val controllers_HomeController_newAccount6_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("newAccount")))
  )
  private[this] lazy val controllers_HomeController_newAccount6_invoker = createInvoker(
    HomeController_1.newAccount,
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.HomeController",
      "newAccount",
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:11
    case controllers_HomeController_rules5_route(params@_) =>
      call { 
        controllers_HomeController_rules5_invoker.call(HomeController_1.rules)
      }
  
    // @LINE:12
    case controllers_HomeController_newAccount6_route(params@_) =>
      call { 
        controllers_HomeController_newAccount6_invoker.call(HomeController_1.newAccount)
      }
